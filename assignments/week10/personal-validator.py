...
print ("=== PERSONAL INFORMATION VALIDAOR ===")
...
if phoneFlag:
    ...
    print("Phone: Invalid (not 10-digi number)")

print("\nFormatetted Information:")
print("Name" , name.upper(), name.lower())
if int(age) >= 18 and int(age) <= 30:
    print("Age Group: Young Adullt (18-30)")
else:
