...
def get_range_hint(number, current_min=1, current_max=100):
    ...
    return f"HINT: The narrowed range arount the numbber is {range(number -12, number +12)}"
...
print("Youhave unlimited attempts.")

while True:
    guess_number = int(input("Atttemp ... - Enter your guess: "))
